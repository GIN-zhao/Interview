...
template <typename Value, typename UnitaryValue, typename TotalValue> 
inline TotalValue Energy<Value,UnitaryValue,TotalValue>::minimize() { return Econst + maxflow(); }

template <typename Value, typename UnitaryValue, typename TotalValue> 
inline int Energy<Value,UnitaryValue,TotalValue>::get_var(Var x) { return (int) what_segment(x); }
